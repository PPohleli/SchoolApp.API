...
namespace SchoolApp.API.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
            ...
            AppDbContext context, IConfiguration configuration, TokenValidationParameters tokenValidationParameters)
        {
            ...
            _tokenValidationParameters = tokenValidationParameters; //inject token validation parameters
        }
        ...
        public async Task<IActionResult> Register([FromBody]RegisterVM registerVM)
        {
            ...
            if (result.Succeeded)
            {
                ...
                {
                    case UserRoles.Manager: await _userManager.AddToRoleAsync(newUser, UserRoles.Manager); break;
                    case UserRoles.Student: await _userManager.AddToRoleAsync(newUser, UserRoles.Student); break;
                    default:
                        break;
                }
